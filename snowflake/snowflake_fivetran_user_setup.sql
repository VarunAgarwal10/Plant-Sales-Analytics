...
-- The following script will create a FIVETRAN USER and ROLE in Snowflake. This user with the roles will be used by Fivetran to load data into the LOAD database.
...
begin;
   ...
   set user_password = '### SET YOUR FIVETRAN USER PASSWORD ####';
   set warehouse_name = 'FIVETRAN_WAREHOUSE';
   
   -- Snowflake Database where FIVETRAN will load the data
   set database_name = 'LOAD'; 
